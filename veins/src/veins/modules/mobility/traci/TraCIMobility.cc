...
void TraCIMobility::Statistics::recordScalars(cSimpleModule& module)
{
	...
	module.recordScalar("startTime", startTime.inUnit(SIMTIME_MS));
	module.recordScalar("totalTime", totalTime.inUnit(SIMTIME_MS));
	module.recordScalar("stopTime", stopTime.inUnit(SIMTIME_MS));

...
simtime_t Mac1609_4::getFrameDuration(int payloadLengthBits, enum PHY_MCS mcs) const {
    ...
    if (mcs == MCS_DEFAULT) {
        ...
        std::cout<<"ndbps: "<<ndbps<<std::endl;
    }

    std::cout<<"PHY_HDR_PREAMBLE_DURATION: "<<PHY_HDR_PREAMBLE_DURATION<<std::endl;
	std::cout<<"PHY_HDR_PLCSIGNAL_DURATION: "<<PHY_HDR_PLCPSIGNAL_DURATION<<std::endl;
	std::cout<<"T_SYM_80211P: "<<T_SYM_80211P<<std::endl;
	std::cout<<"PayloadBits: " <<payloadLengthBits<<std::endl;
...
void Mac1609_4::sendAck(int recpAddress, unsigned long wsmId) {
	...
	std::cout<<sendingDuration<<std::endl;
